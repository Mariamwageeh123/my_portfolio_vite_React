...
export default function About() {
  ...
  <div className="card">
    <div className="card-header text-primary"><i className="fa-solid fa-code icon"></i>Frontend Developer</div>
    <div className="card-body">Freelancer</div> 
...
<div className="container mt-3 col-5">
  ...
  <div className="card ">
    <div className="card-header text-primary"><i className="fa-solid fa-person-chalkboard icon"></i>
        Code Instructur</div>
    <div className="card-body">Worked for Ischool and NTG</div> 
